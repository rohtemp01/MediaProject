...
import com.example.mp_app.util.DialogUtil;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    if ("yes".equals(snapshot.getValue(String.class))) {
                        Intent intent = new Intent(AcceptAct.this, ProfileAct.class);
                        intent.putExtra("tempkey2", tempkey);
                        Toast.makeText(AcceptAct.this, "연결되었습니다", Toast.LENGTH_SHORT).show();
                        countDown.cancel();
                        startActivity(intent);
                    }
                    Toast.makeText(AcceptAct.this, snapshot.getValue(String.class), Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void timer() {
        countDown = new CountDownTimer(1000 * 60 * 60 * 24, 100) {
            ...
            public void onFinish() {
                ...
                if (hours == "0") {
                    DialogUtil.showDialog("제한 시간이 지났습니다.", AcceptAct.this, false);
                }
            }
        }.start();
    }
